 ...
 * @LastEditTime: 2021-10-14 16:04:15
 * @LastEditors: yuyang
 */
      ...
      >
        {
          studentNewsList.map((newsList, idx) => (
            <div>
              <div className="w-full px-4 py-8 flex items-center justify-between" key={idx}>
                {
                  newsList.map((item) => (
                    <div className="w-1/3" key={item.id}>
                      <div className="w-60 h-80 flex flex-nowrap flex-col justify-start items-center rounded-t-xl shadow-hs2 overflow-hidden transform transition hover:-translate-y-2">
