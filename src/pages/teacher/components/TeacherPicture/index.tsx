...
const TeacherPicture: React.FC = () => (
  <>
    <div className={styles.teacherPicture}>
      <div className="flex">
        <Slide imgUrl={pic1} text="学科渗透生涯支持(学科融合)" />
        <Slide imgUrl={pic2} text="生涯活动案例库" />
        <Slide imgUrl={pic3} text="生涯教育基础知识" />
      </div>
      <div className="flex h-64">
        <div style={{ width: '40%', height: '100%' }}>
          <Slide imgUrl={pic4} text="生涯辅导(咨询类)专栏" />
        </div>
        <div style={{ width: '56%', height: '100%' }}>
          <Slide imgUrl={pic5} text="主题课程设计类专栏" />
        </div>
      </div>
    </div>
  </>
